...
/**
 * Tests for {@link TypedSingleNonOptionPrimitiveArgument}.
 * @author Jason Smith
 */
public class TypedSingleNonOptionPrimitiveArgumentIT extends AbstractIT
{
	/**
	...
	public void testPassOneValue() throws Exception
	{
		assertEquals("Returned the wrong value.", 
				"42", 
				new Subprocess(getCommand("typedsinglenonoptionprimitiveargument").getPath(), "42").call(StreamUtil.DEFAULT_CHARSET));
	}
	...
	{
		new Subprocess(getCommand("typedsinglenonoptionprimitiveargument").getPath(), "42", "43").call(StreamUtil.DEFAULT_CHARSET);
	}
	...
	public void testPassZeroValues() throws Exception
	{
		assertEquals("Didn't return the expected default value.", 
				"256", 
				new Subprocess(getCommand("typedsinglenonoptionprimitiveargument").getPath()).call(StreamUtil.DEFAULT_CHARSET));
	}
	...
	{
		new Subprocess(getCommand("typedsinglenonoptionprimitiveargument").getPath(), "wont-convert").call(StreamUtil.DEFAULT_CHARSET);
	}
}
